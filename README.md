...
I'm a dedicated **Software Development Engineer** with **5+ years of experience** building scalable, high-performance cloud-native applications and data pipelines. As an SDE-II from the **Microsoft Security org**, I contribute to building secure agentic AI platforms and incident response automation. Previously, at **Amazon Web Services**, I developed highly available, secure services powering AWS Security, from RESTful Go APIs to distributed AWS cloud infrastructure. I hold a **Master’s in Information Systems (Big Data & Analytics)** from *Georgia State University* and have delivered at scale with **Python**, **Go**, **AWS**, and **distributed systems**. I thrive tackling complex problems in collaborative teams and enjoy sharing knowledge with the technical community.
...
### Full-Stack & Intelligence Systems
[![Readme Card](https://github-readme-stats.vercel.app/api/pin/?username=satyarajreddy&repo=geosignal-terminal&theme=radical)](https://github.com/satyarajreddy/geosignal-terminal) [![Readme Card](https://github-readme-stats.vercel.app/api/pin/?username=satyarajreddy&repo=structbench&theme=radical)](https://github.com/satyarajreddy/structbench)

- **[geosignal-terminal](https://geosignal-terminal.vercel.app/)**: A real-time market intelligence system tracking geopolitical impacts (crude oil, conflicts) on Indian equity markets. Features a FastAPI Signal Engine and an 11-endpoint monitoring status page.
- **[structbench](https://structbench.vercel.app/)**: A comprehensive LLM evaluation framework designed to benchmark structured data generation. Powered by **Amazon Bedrock (Claude 3.5)**, **FastAPI**, and **Supabase** for high-fidelity structured analytics and performance tracking.
...
GPA: 3.52/4 | Graduate Research Assistant
...
- **AI/ML Integration**: Amazon Bedrock, GenAI applications, LLM Benchmarking
- **Geopolitical Market Intelligence**: Real-time signal analysis and sector watchlists
...
- 🌐 Portfolio: [satyaraj.dev](https://satyaraj.dev/)
